...
async function startup() {
  ...
  // 1. HTTP server sobe PRIMEIRO — o Render exige health check antes de liberar rede de saída
  ...
  // 2. Aguarda 2s para o Render registrar o health check antes de abrir conexões externas
  await new Promise(r => setTimeout(r, 2000));

  // 3. MongoDB
  await connectDB();

  // 4. Discord login — sem timeout artificial; deixa o discord.js tentar pelo tempo que precisar
